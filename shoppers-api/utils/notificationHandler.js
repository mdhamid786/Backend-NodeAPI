...
const notification = require("../utils/messages/notification");

exports.handleNotification = (messageCode, user_id, err, req, res) => {
  const appMessage = notification.appMessages[messageCode].message;
  const appMessageCode = notification.appMessages[messageCode].severity;
  console.log(appMessageCode)
  const appResponseCode = 
    notification.appMessages[messageCode].responseCode;
